...
<head>
    ...
    <meta property="og:url" id="fbUrl" content="https://yongnology.synology.me/">
    ...
    <meta property="og:url" content="https://yongnology.synology.me/" />
    <meta property="og:image" id="fbImg" content="https://img.megabox.co.kr/SharedImg/metaTag/2020/02/04/gFfTzMwwiCxhBwcUV5TRGMFX9Cmoj64W.jpg">
   
    <!-- 트위터 메타 태그 -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="메가박스 사이트 만들기">
    <meta name="twitter:url" content="https://yongnology.synology.me//">
    <meta name="twitter:image" content="https://img.megabox.co.kr/SharedImg/metaTag/2020/02/04/gFfTzMwwiCxhBwcUV5TRGMFX9Cmoj64W.jpg">
    <meta name="twitter:description" content="사람들과 공유할 수 있는, 공간경험을 만듭니다.">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="header clearfix">
                    ...
                    <nav class="nav">
                        <li class="main-menu">
                            <a href="more_movie.html">영화</a>
                            <ul class="sub-menu">
                                <li><a href="more_movie.html">전체영화</a></li>
                            </ul>
                        </li>
                        <!-- main-menu2 -->
                        <li class="main-menu">
                            ...
                            <ul class="sub-menu">
                                <li><a href="ticketing.html">빠른예매</a></li>
                            </ul>
                        </li>
                        <!-- main-menu3 -->
                        <li class="main-menu lmovie-menu">
                            <a href="theater.html">극장</a>
                            <ul class="sub-menu sub-menu-rw">
                                <li><a href="theater.html">전체극장</a></li>
                                <li><a href="theater_spcial.html">특별관</a></li>
                            </ul>
                        </li>
                        <!-- main-menu4 -->
                        <li class="main-menu rmovie-menu">
                        ...
                        <!-- main-menu6 -->
                        <li class="main-menu rmovie-menu ">
                            <a href="benefit.html">혜택</a>
                            <ul class="sub-menu sub-menu-gx">
                                <li><a href="benefit.html">메가박스 멤버십</a></li>
                            </ul>
                        </li>
                        <li class="main-menu rmovie-menu ">
                            <a class="login" onclick="popupOpen()">로그인</a>
                        </li>
                    </nav>   
                </div>
            </div>
    ...
    <!-- 로그인 영역 ------------------------------------------------------------------->
        <div class="login_root">
            <div class="login1">  
                <div class="purple_var">
                    <span>로그인</span>
                    <input class="poplogClose" type="button" value="X" onclick="popupClose()">
                    <!--<button class="poplogClose">xx</button> -->
                </div>
                <div class="login_wrap">
                    <div class="left_login">
                        <form method="post" action="#">
                            <table>
                                <tr>
                                    <td colspan="3" width="380" align="center"><input class="login_input" type="text" id="id" name="id" placeholder="아이디"></td>
                                </tr>
                                <tr>
                                    <td colspan="3"  width="380" align="center"><input class="login_input" type="password" id="pwd"name="pwd" placeholder="비밀번호"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" ><input type="checkbox" id="rememberid">&nbsp아이디 저장</td>
                                </tr>
                                <tr>
                                    <td colspan="3" ><input type="submit" id="login_button" class="login_button" value="로그인" disabled></td>
                                </tr>
                                <tr class="login_three">
                                    <td>
                                        <span><a href="#">ID/PW 찾기</a></span>
                                    </td>
                                    <td>
                                        <span><a href="join1.html">회원가입</a></span>
                                    </td>
                                    <td>
                                        <span><a href="#">비회원 예매확인</a></span>
                                    </td>
                                </tr>
                            </table>
                        </form>
                    ...
                    <div class="right_login">
                        <img class="ad" src="img/login_ad.jpg" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="movie">
        <div class="main-img">
            <img src="img/index-bg.png" alt="메인">
        </div>
        <div class="container">
            <div class="row">
                        ...
                        <div class="swiper-container2">
                           <div class="chart_cont1 swiper-wrapper">
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster01.jpg" srcset="img/poster01@2.jpg 2x" alt="블랙 팬서">
                                       </figure>
                                   ...
                                   <div class="infor">
                                       <div class="infor_btn">
                                           <a href="#" class="info_btn">상세정보</a>
                                           <a href="#" class="buy_btn">예매</a>
                                       </div>
                                   </div>
                               </div>
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster02.jpg" srcset="img/poster02@2.jpg 2x" alt="동감">
                                       </figure>
                                   ...
                                   <div class="infor">
                                        <div class="infor_btn">
                                            <a class="info_btn" href="#">상세정보</a>
                                            <a class="buy_btn" href="#">예매</a>
                                        </div>
                                    </div>
                               </div>
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster03.jpg" srcset="img/poster03@2.jpg 2x" alt="데시벨">
                                       </figure>
                               ...
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster04.jpg"  alt="에브리씽 에브리웨어 올 앳 원스">
                                       </figure>
                               ...
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster05.jpg" alt="인생은 아름다워">
                                       </figure>
                               ...
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster06.jpg" alt="올빼미">
                                       </figure>
                               ...
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster07.jpg"  alt="오펀: 천사의 탄생">
                                       </figure>
                               ...
                               <div class="swiper-slide">
                                   <div class="poster">
                                       <figure>
                                           <img src="img/poster08.jpg"  alt="공조2: 인터내셔날">
                                       </figure>
                        ...
                        <div class="swiper-container2">
                            <div class="chart_cont2 swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster001.jpg" srcset="img/poster001.jpg 2x" alt="리멤버">
                                        </figure>
                                        <div class="rank"><strong>1</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster002.jpg" srcset="img/poster002.jpg 2x" alt="자백">
                                        </figure>
                                        <div class="rank"><strong>2</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster003.jpg" srcset="img/poster003.jpg 2x" alt="[워너필소] 카사블랑카">
                                        </figure>
                                        <div class="rank"><strong>3</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster004.jpg" srcset="img/poster004.jpg 2x" alt="아인보: 아마존의 전설">
                                        </figure>
                                        <div class="rank"><strong>4</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster005.jpg" srcset="img/poster005.jpg 2x" alt="극장판 유루캠△">
                                        </figure>
                                        <div class="rank"><strong>5</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/poster006.jpg" srcset="img/poster006.jpg 2x" alt="죽어도 자이언츠">
                                        </figure>
                                        <div class="rank"><strong>6</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                        ...
                        <div class="swiper-container2">
                            <div class="chart_cont3 swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0001.jpg" srcset="img/0001.jpg 2x" alt="[시네마캐슬] 너의 이름은.">
                                        </figure>
                                        <div class="rank"><strong>1</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0002.jpg" srcset="img/0002.jpg 2x" alt="[시네마캐슬] 날씨의 아이">
                                        </figure>
                                        <div class="rank"><strong>2</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0003.jpg" srcset="img/0003.jpg 2x" alt="[시네마캐슬] 라이어×라이어">
                                        </figure>
                                        <div class="rank"><strong>3</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0004.jpg" srcset="img/0004.jpg 2x" alt="[시네마캐슬] 너의 췌장을 먹고 싶어">
                                        </figure>
                                        <div class="rank"><strong>4</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0005.jpg" srcset="img/0005.jpg 2x" alt="[시네마캐슬] 인간실격">
                                        </figure>
                                        <div class="rank"><strong>5</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="poster">
                                        <figure>
                                            <img src="img/0006.jpg" srcset="img/0006.jpg 2x" alt="[시네마캐슬] 꽃다발 같은 사랑을 했다">
                                        </figure>
                                        <div class="rank"><strong>6</strong></div>
                                        <div class="mx">
                                            <span class="icon m ir_pm">MX</span>
        ...
        <div class="event_container">
            <div class="animation_canvas">
                ...
                <div class="slider_panel">
                    <a href=""><img class="slider_image" src="img/event01.jpg"  alt="삼성페이X메가박스"></a>
                    <a href=""><img class="slider_image" src="img/event02.jpg" alt="신규이벤트"></a>
                    <a href=""><img class="slider_image" src="img/event03.jpg" alt="메가박스 오리지널 티켓"></a>
                    <a href=""><img class="slider_image" src="img/event04.jpg" alt="메가박스 오리지널 티켓"></a>
                </div>
                <!--좌우 컨트롤 버튼 패널-->
                <div class="left_right_conrtrol_panel conrtrol_button">
                    <span class="left_control">&lang;</span>
                    <span class="right_control">&rang;</span>
                </div>
            </div>
            <div class="right_event">
                <img id="event05"src="img/event05.jpg" alt="메가박스X광주은행">
            </div>
            <div class="bottom_event">
                <img id="event06" src="img/event06.jpg" alt="삼성화재 다이렉트">
                <img id="event07" src="img/event07.jpg" alt="웰컴박스">
            </div>
        </div>
    </div>
    <!-- //event -->
    <section class="curation">
        <div class="curation-wrap">
            <div class="tit-util">
                ...
                <div class="right">
                    <a href="/curation/filmsociety" title="큐레이션 더보기">
            ...
            <!-- curr-img -->
            <div class="curr-img">
                <p class="bage"><img src="img/p.png" alt=""></p>
                <div class="img">
                    <a href="#" title="영화상세 보기">
                        <img src="https://img.megabox.co.kr/SharedImg/2022/10/14/iBBnWtGu1pQDiOnGyN1eNx6ZgvfXfh5B_420.jpg" alt="로열 오페라 하우스 '22-23시즌" onerror="noImg(this, 'main');">
                    </a>
                </div> 
                <div class="btn-group justify">
                    ...
                    <div class="right">
                        <a href="#" class="button gblue" title="개봉예정">개봉예정</a>
                    </div>
                </div>
                <div class="info classic">
                    <p class="txt">#<span>클래식소사이어티</span></p>
                    <p class="tit">로열 오페라 하우스 '22-23시즌'</p>
                    <div class="_p"></div>
                    <p class="summary">
                        메가박스 클래식소사이어티의 새로운 프로그램을 소개합니다. <br><br>역대 가장 화려한 시즌을 맞이한 로열 오페라 하우스 2022/23 시즌<br><br>[상영일]<br>2022년 10월 31일 ~ 2023년 8월 14일<br>발레 : 매주 월요일/일요일 상영 <br>오페라 : 매주 월요일 상영<br></p>
                </div>
            </div>
            <!--// curr-img -->
            <div class="list">
                <ul>
                    <li>
                        <a href="#" title="영화상세 보기">
                        <p class="bage film"></p>
                            <p class="list_bage"><img src="img/q.png" alt=""></p>
                            <div class="img"><img src="https://img.megabox.co.kr/SharedImg/2022/09/05/lQCgVHnv9PondWhG1eERKIDemlhzQG2R_230.jpg" alt="[워너필소] 카사블랑카" onerror="noImg(this, 'main');"></div>
                        <p class="tit">[워너필소] 카사블랑카</p>
                    </li>
                    <li>
                        <a href="#" title="영화상세 보기">
                        <p class="bage film"></p>
                            <p class="list_bage"><img src="img/q.png" alt=""></p>
                            <div class="img"><img src="https://img.megabox.co.kr/SharedImg/2022/09/05/pshGbPkxbpD93qWajPgJMo71BymEmj1Q_230.jpg" alt="[워너필소] 브이 포 벤데타" onerror="noImg(this, 'main');"></div>
                            <p class="tit">[워너필소] 브이 포 벤데타</p>
                        </a>
                    </li>
                    <li>
                        <a href="#" title="영화상세 보기">
                        <p class="bage film"></p>
                            <p class="list_bage"><img src="img/q.png" alt=""></p>
                            <div class="img"><img src="https://img.megabox.co.kr/SharedImg/2022/10/25/GUJ1h0v2t5u965lkwXIkIqnHZXGUR9xT_230.jpg" alt="알카라스의 여름" onerror="noImg(this, 'main');"></div>
                        <p class="tit">알카라스의 여름</p>
                    </li>
                    <li>
                        <a href="#" title="영화상세 보기">
                        <p class="bage classic"></p>
                            <p class="list_bage"><img src="img/q.png" alt=""></p>
                            <div class="img"><img src="https://img.megabox.co.kr/SharedImg/2022/06/08/HknUnJDiL5qtpTSLLeoeEWyCX5SSPaGF_230.jpg" alt="[2022 시네도슨트] 브리티쉬 뮤지엄&amp;내셔널 갤러리" onerror="noImg(this, 'main');"></div>
                        <p class="tit">[2022 시네도슨트] 브리티쉬 뮤지엄&amp;내셔널 갤러리</p>
                        </a>
                    </li>
                </ul>
            </div>
                            ...
                            <ul>
                                <li class="active"><a href="#">전체 공지</a>
                                    <ul>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">코엑스</strong> <em>2022.10.17</em></dt>
                                                <dd>[코엑스] 10/20(목) <리멤버> 시사회 진행에 따른 이용안내</dd>
                                            </dl>            
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">메가박스</strong> <em>2022.10.11</em></dt>
                                                <dd>메가박스 시스템 점검 안내 (10/18)</dd>
                                            </dl>
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">코엑스</strong> <em>2022.10.11</em></dt>
                                                <dd>[코엑스] 부티크 프라이빗 공사에 따른 이용 안내 (10/11~12월 중순)</dd>
                                            </dl>
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">구미강동</strong> <em>2022.10.11</em></dt>
                                                <dd>[구미강동] 10월 7일 건물정전으로 인한 상영중단 및 취소 안내</dd>
                                            </dl>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#">영화관 공지</a>
                                    <ul>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">공지</strong> <em>2022.10.11</em></dt>
                                                <dd>메가박스 시스템 점검 안내 (10/18)</dd>
                                            </dl>            
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">공지</strong> <em>2022.10.07</em></dt>
                                                <dd>메가박스 개인정보 처리방침 변경 안내</dd>
                                            </dl>
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">공지</strong> <em>2022.10.05</em></dt>
                                                <dd>아이돌리쉬 세븐 Re:vale LIVE GATE “Re:flect U” 라이브뷰잉 진행 안내</dd>
                                            </dl>
                                        </li>
                                        <li>
                                            <dl>
                                                <dt><strong class="bar">공지</strong> <em>2022.09.20</em></dt>
                                                <dd>[(4K HDR)아바타 리마스터링] - 관람안내</dd>
                                            </dl>
                                        </li>
                                    </ul>
                                </li>
